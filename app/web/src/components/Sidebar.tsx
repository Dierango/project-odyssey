  ...
  return (
    <div className="flex flex-col h-full bg-gray-800 text-white w-64 p-4 border-r border-gray-700 shadow-lg">
      ...
      <button
        ...
        className="flex items-center bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg mb-2 transition-colors w-full justify-center"
      >
      ...
      <Link
        href="/"
        className="flex items-center bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-lg mb-4 transition-colors w-full justify-center"
      >
